...
const styles = StyleSheet.create({
  ...
  input: { minHeight: 60, borderWidth: 1, borderColor: '#ddd', borderRadius: 8, padding: 8, backgroundColor: '#fff', marginTop: 8 },
  ...
  msg: { marginTop: 6, fontSize: 16, color: '#111', padding: 6, backgroundColor: '#fff', borderRadius: 8, borderWidth: 1, borderColor: '#eee' },
